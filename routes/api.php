...
Route::post('/v1/resetpassword/initialize', 'ForgotPasswordController@initializeOTP');
Route::post('/v1/resetpassword/verify', 'ForgotPasswordController@verifyOTP');
Route::post('/v1/resetpassword/store', 'ForgotPasswordController@resetPassword');
...
Route::get('/v1/remittance/monetacallback/card/{agent_id}/{month}/{amount}','RemittanceController@storeCardPayment');
...
Route::get('/v1/lga/completeYearRevenue', 'RevenueController@completeYearRevenue');
...
Route::prefix('v1')->middleware('auth:api')->group(function(){
    ...
    Route::post('/head', 'AgentController@head');
   ...
   // unremit listing
    ...
    Route::post('/offlineData', 'RevenueController@handlingOfflineData');
    Route::get('/offlineDataTrail/{packet_id}', 'RevenueController@getOfflineDataTrail');
...
Route::get('firebase', 'RevenueController@firebase');