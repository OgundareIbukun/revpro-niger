<template>
    ...
    <div>
        ...
        <div class="page-body" v-if="!this.$auth.isDashboard()">

            <div  class="alert alert-info">  You`re welcome to Niger State & LGA Harmonized Revenue Portal </div>
        </div>
        <div v-else="" class="page-body">
            ...
            <div class="row clearfix">
                ...
                <div  id="metrics3" class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div class="small-box bg-purple">
                        ...
                        <div class="inner">
                            <h4>{{new Intl.NumberFormat('en-NG', {
                                style: 'currency',
                                currency: 'NGN'
                            }).format(metrics.overall)}}</h4>

                            <p><small>Overall Total Revenue Generated</small></p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-tags"></i>
                        </div>
                        <a href="/home#/remittance" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>

                </div>

                <div id="metrics1" class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <!-- small box -->
                    <div class="small-box bg-green">
                        ...
                        <div class="inner">
                            ...
                            <p><small>Total Generated for the Month</small></p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-tag"></i>
                        </div>
                        <a href="/home#/noncash-invoices" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>

                </div>

                <div id="metrics2" class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <div class="inner">
                            ...
                            <p><small>Total in the Bank</small></p>
                        </div>
                        <div class="icon">
                ...
                <div  id="metrics4" class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
...
//                itemsPerPage: 10,
        ...
        methods:{
            ...
            hidePreLoader(){
                ...
                this.card_1 = this.card_2 = this.card_3 =this.card_4 = this.table_1=  false;
            },
