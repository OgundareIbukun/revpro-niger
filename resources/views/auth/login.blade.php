...
<body class="hold-transition login-page body" style="">

<div class="login-box"   >
    <div align="center"   ><img  style="width:320px"  class="width-logo"  src="assets/images/portallogo.png" /></div>
    ...
    <div class="login-box-body "     >
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="row">
                ...
                <div align="center" class="col-xs-4">
                    <input type="submit" style="background-color:#00b4e3;border-color:#00b4e3; " class="btn btn-primary btn-sm btn-block btn-flat" value="Log in" />
                </div><!-- /.col -->
            </div>
        </form>
        ...
        <div   align="center" style="margin-top:100px;" ><a  style="color:black"  target="_blank" href="https://www.weevilcompany.com" />Powered by: Weevil Company.</div><br/>
