...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
              ...
              case 0:
                ...
                return axios.post('/user', {
                  ...
                  if (response.data.status == 'success') {
                    ...
                    _this2.users.unshift(response.data.data);
                  }
    ...
    editUser: function editUser(user) {
      ...
      this.user.id = user.id, this.user.name = user.name, this.user.email = user.email, this.user.phone = user.phone, this.user.category_id = user.category_id, this.user.role_id = user.role_id, this.user.lga_id = user.lga_id; // $('#editUsersModal').modal('show');
    },
    updateUser: function () {
